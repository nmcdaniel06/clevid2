<?php require 'php/hat.php'; ?>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <p>Let us bring your vision to life with our modern style and innovative design techniques! From basic formatting to custom graphics production, Clevid is here to design a site that is both practical and aesthetic. With years of experience building and visualizing websites, we take pride in what we create. Clevid can bring the look and feel of your business to the interactive forum of the World Wide Web. We can use any of the images, logos, or visuals you love from your existing promotional materials and integrate them into a site that reflects your current business design, or work with you to create a new concept all together. Let Clevid take your online presence to the next level!</p>
      </div><!--endCol------------------------------>
...
<div class="row">
  ...
  <h3>By Phone: 832-534-3611</h3><br />
  <h3>Or by email:</h3><br />
